...
function Menu(props) {
	...
	return (
		<div className="menuDiv p-2" style={{ marginTop: "4rem" }}>
			<div className="container-md menuList mt-1">
				<div className="pt-2 d-flex justify-content-center ">
					<ul
						className="nav nav-tabs d-inline-flex px-4 rounded-4 justify-content-center "
						style={{
					...
					>
						...
						<li className="nav-item fs-5" onClick={() => toggleDiv(2)}>
							<a className="nav-link">COFFEE</a>
						</li>
						<li className="nav-item fs-5" onClick={() => toggleDiv(3)}>
							<a className="nav-link">TEA</a>
						</li>
						<li className="nav-item fs-5" onClick={() => toggleDiv(4)}>
							<a className="nav-link">PASTRIES</a>
						</li>
						<li className="nav-item fs-5" onClick={() => toggleDiv(5)}>
							<a className="nav-link">SALADS</a>
						</li>
						<li className="nav-item fs-5" onClick={() => toggleDiv(6)}>
							<a className="nav-link">BEVERAGES</a>
						</li>
						<li className="nav-item fs-5" onClick={() => toggleDiv(7)}>
