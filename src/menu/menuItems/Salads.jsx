...
function Salads(props) {
    ...
    const handleClick = (item , index) => {
        ...
        const sala = document.querySelectorAll(".sal");
        sala[index].classList.toggle("slidee");

        setTimeout(() => {
            sala[index].classList.remove("slidee");
        }, 1000);
    };
                                            ...
                                            <div className="p-1 col-8">
                                                <div className="d-flex align-items-center mx-2 mx-md-3 mx-lg-4 mx-xl-5">
                                                    <div className="position-relative ">
                                                        ...
                                                        />
                                                        <span className="left-0 bottom-0 sal start-0  rounded position-absolute">
