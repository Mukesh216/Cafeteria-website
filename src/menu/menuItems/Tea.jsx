...
function Tea(props) {
    ...
    const handleClick = (item , index) => {
        ...
        const teaa = document.querySelectorAll(".te");
        teaa[index].classList.toggle("slidee");

        setTimeout(() => {
            teaa[index].classList.remove("slidee");
        }, 1000);
                                    ...
                                    <div className="row mt-4 justify-content-center" key={index}>
                                        <div className="p-1 col-8">
                                            <div className="d-flex align-items-center mx-2 mx-md-3 mx-lg-4 mx-xl-5">
                                                <div className="position-relative ">
                                                    ...
                                                    />
                                                    <span className="left-0 bottom-0 te start-0  rounded position-absolute">
                                        ...
                                        <div className="p-1 col-4 d-flex align-items-center ">
                                            <div className="d-flex justify-content-sm-around  justify-content-between align-items-center w-100">
                                                ...
                                                {/* Button with spacing */}
                                                <button
                                                    className="p-2  ado rounded-2 d-flex align-items-center me-3 me-sm-1 px-2 "
