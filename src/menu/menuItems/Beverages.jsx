...
import { beveragesItems } from "./MenuList";
...
function Beverages(props) {
    ...
    const handleClick = (item, index) => {
        ...
        const beve = document.querySelectorAll(".bev");
        beve[index].classList.toggle("slidee");

        setTimeout(() => {
            beve[index].classList.remove("slidee");
        }, 1000);
    };
                                        ...
                                        <div className="p-1 col-8">
                                            <div className="d-flex align-items-center mx-2 mx-md-3 mx-lg-4 mx-xl-5">
                                                <div className="position-relative ">
                                                    ...
                                                    />
                                                    <span className="left-0 bottom-0 bev start-0  rounded position-absolute">
